          ...
          <li class="dropdown user user-menu">	
			...
			<ul class="dropdown-menu animated flipInX">
			  <li class="user-body">
				 ...
				 <a class="dropdown-item" href="{{route('admin.change.password')}}"><i class="ti-lock text-muted mr-2"></i> Change Password</a>				 <a class="dropdown-item" href="#"><i class="ti-settings text-muted mr-2"></i> Settings</a>
